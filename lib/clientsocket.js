...
AGClientSocket.prototype.closeChannel = function (channelName) {
  this.channelCloseOutputStream(channelName);
  this.channelCloseAllListeners(channelName);
};

AGClientSocket.prototype.closeAllChannelOutputStreams = function () {
...
AGClientSocket.prototype.closeAllChannels = function () {
  this.closeAllChannelOutputStreams();
  this.closeAllChannelListeners();
};

AGClientSocket.prototype.killChannel = function (channelName) {
  this.channelKillOutputStream(channelName);
  this.channelKillAllListeners(channelName);
};

AGClientSocket.prototype.killAllChannelOutputStreams = function () {
...
AGClientSocket.prototype.killAllChannels = function () {
  this.killAllChannelOutputStreams();
  this.killAllChannelListeners();
};

AGClientSocket.prototype.killChannelOutputStreamConsumer = function (consumerId) {
...
AGClientSocket.prototype.getChannelOutputStreamConsumerStats = function (consumerId) {
...
AGClientSocket.prototype.getAllChannelOutputStreamsConsumerStatsList = function () {
...
AGClientSocket.prototype.getChannelBackpressure = function (channelName) {
  return Math.max(
    this.channelGetOutputStreamBackpressure(channelName),
    this.channelGetAllListenersBackpressure(channelName)
  );
};

AGClientSocket.prototype.getAllChannelOutputStreamsBackpressure = function () {
...
AGClientSocket.prototype.getAllChannelsBackpressure = function () {
  return Math.max(
    this.getAllChannelOutputStreamsBackpressure(),
...
AGClientSocket.prototype.getChannelOutputStreamConsumerBackpressure = function (consumerId) {
  return this._channelDataDemux.getConsumerBackpressure(consumerId);
};

AGClientSocket.prototype.hasAnyChannelOutputStreamConsumer = function (consumerId) {
...
AGClientSocket.prototype.channelCloseOutputStream = function (channelName) {
...
AGClientSocket.prototype.channelCloseAllListeners = function (channelName) {
  this.channelCloseListener(channelName, 'kickOut');
  this.channelCloseListener(channelName, 'subscribeStateChange');
  this.channelCloseListener(channelName, 'subscribe');
  this.channelCloseListener(channelName, 'subscribeFail');
  this.channelCloseListener(channelName, 'unsubscribe');
};

AGClientSocket.prototype.channelKillOutputStream = function (channelName) {
...
AGClientSocket.prototype.channelKillAllListeners = function (channelName) {
  this.channelKillListener(channelName, 'kickOut');
  this.channelKillListener(channelName, 'subscribeStateChange');
  this.channelKillListener(channelName, 'subscribe');
  this.channelKillListener(channelName, 'subscribeFail');
  this.channelKillListener(channelName, 'unsubscribe');
};

AGClientSocket.prototype.channelGetOutputStreamConsumerStatsList = function (channelName) {
...
AGClientSocket.prototype.channelGetAllListenersConsumerStatsList = function (channelName) {
  return this.channelGetListenerConsumerStatsList(channelName, 'kickOut').concat(
    this.channelGetListenerConsumerStatsList(channelName, 'subscribeStateChange'),
    this.channelGetListenerConsumerStatsList(channelName, 'subscribe'),
    this.channelGetListenerConsumerStatsList(channelName, 'subscribeFail'),
    this.channelGetListenerConsumerStatsList(channelName, 'unsubscribe')
  );
};

AGClientSocket.prototype.channelGetOutputStreamBackpressure = function (channelName) {
...
AGClientSocket.prototype.channelGetAllListenersBackpressure = function (channelName) {
  return Math.max(
    this.channelGetListenerBackpressure(channelName, 'kickOut'),
    this.channelGetListenerBackpressure(channelName, 'subscribeStateChange'),
    this.channelGetListenerBackpressure(channelName, 'subscribe'),
    this.channelGetListenerBackpressure(channelName, 'subscribeFail'),
    this.channelGetListenerBackpressure(channelName, 'unsubscribe')
  );
};

AGClientSocket.prototype.channelHasOutputStreamConsumer = function (channelName, consumerId) {
