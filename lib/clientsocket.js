...
AGClientSocket.prototype.closeChannelData = function (channelName) {
  this._channelDataDemux.close(channelName);
};

AGClientSocket.prototype.closeChannelListener = function (channelName, eventName) {
  this._channelEventDemux.close(`${channelName}/${eventName}`);
};

AGClientSocket.prototype.closeAllChannelListeners = function (channelName) {
...
AGClientSocket.prototype.closeAllChannelsData = function () {
  this._channelDataDemux.closeAll();
};

AGClientSocket.prototype.closeAllChannelsListeners = function () {
...
AGClientSocket.prototype.killChannelData = function (channelName) {
  this._channelDataDemux.kill(channelName);
};

AGClientSocket.prototype.killChannelListener = function (channelName, eventName) {
  this._channelEventDemux.kill(`${channelName}/${eventName}`);
};

AGClientSocket.prototype.killAllChannelListeners = function (channelName) {
...
AGClientSocket.prototype.killAllChannelsData = function () {
  this._channelDataDemux.killAll();
};

AGClientSocket.prototype.killAllChannelsListeners = function () {
...
AGClientSocket.prototype.killChannelDataConsumer = function (consumerId) {
...
AGClientSocket.prototype.getChannelDataConsumerStats = function (consumerId) {
...
AGClientSocket.prototype.getChannelDataConsumerStatsList = function (channelName) {
  return this._channelDataDemux.getConsumerStatsList(channelName);
};

AGClientSocket.prototype.getChannelListenerConsumerStatsList = function (channelName, eventName) {
  return this._channelEventDemux.getConsumerStatsList(`${channelName}/${eventName}`);
};

AGClientSocket.prototype.getAllChannelListenerConsumerStatsList = function (channelName) {
...
AGClientSocket.prototype.getAllChannelsDataConsumerStatsList = function () {
  return this._channelDataDemux.getConsumerStatsListAll();
};

AGClientSocket.prototype.getAllChannelsListenerConsumerStatsList = function () {
  return this._channelEventDemux.getConsumerStatsListAll();
};

AGClientSocket.prototype.getChannelDataBackpressure = function (channelName) {
  return this._channelDataDemux.getBackpressure(channelName);
};

AGClientSocket.prototype.getChannelListenerBackpressure = function (channelName, eventName) {
  return this._channelEventDemux.getBackpressure(`${channelName}/${eventName}`);
};

AGClientSocket.prototype.getAllChannelListenersBackpressure = function (channelName) {
  return Math.max(
...
AGClientSocket.prototype.getAllChannelsDataBackpressure = function () {
  return this._channelDataDemux.getBackpressureAll();
};

AGClientSocket.prototype.getAllChannelsListenersBackpressure = function () {
...
AGClientSocket.prototype.getChannelDataConsumerBackpressure = function (consumerId) {
...
AGClientSocket.prototype.hasChannelDataConsumer = function (channelName, consumerId) {
  return this._channelDataDemux.hasConsumer(channelName, consumerId);
};

AGClientSocket.prototype.hasChannelListenerConsumer = function (channelName, eventName, consumerId) {
  return this._channelEventDemux.hasConsumer(`${channelName}/${eventName}`, consumerId);
};

AGClientSocket.prototype.hasAnyChannelListenerConsumer = function (channelName, consumerId) {
...
AGClientSocket.prototype.hasAnyChannelDataConsumer = function (consumerId) {
  return this._channelDataDemux.hasConsumerAll(consumerId);
};

AGClientSocket.prototype.hasAnyChannelsListenerConsumer = function (consumerId) {
