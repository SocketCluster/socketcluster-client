...
SCSocket.prototype.connect = SCSocket.prototype.open = function () {
  ...
  if (this.state == this.CLOSED) {
    ...
    this.transport.on('openFail', function (code, data) {
      self.state = self.CLOSED;
...
SCSocket.prototype._onSCClose = function (code, data, openFail) {
  var self = this;
  ...
  // TODO: It shouldn't always trigger a disconnect event, sometimes it might be
  // a connectFail event. We need a way to tell them appart - Maybe the transport
  // should emit a separate 'openFail' event
